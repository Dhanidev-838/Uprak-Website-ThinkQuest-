...
<head>
    ...
    <style>
        ...
        .header { background:#28a745; color:#fff; padding:20px; display:flex; justify-content:space-between; align-items:center; }
        ...
        .question h3 { margin:0; color:black; }
        ...
        .actions a.delete { background:#28a745; color: #fff; }
        .actions a.edit { background:#28a745; color:#fff; }
