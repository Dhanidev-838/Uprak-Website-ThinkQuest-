    ...
    <div class="question">
        ...
        <?php if(isset($_SESSION['user_id']) && $_SESSION['user_id'] == $question['user_id']): ?>
            <div style="margin-top:10px;">
                <a href="edit_question.php?id=<?= $question['id'] ?>" style="color:orange;">Edit</a>
                <a href="delete_question.php?id=<?= $question['id'] ?>" style="color:red;" onclick="return confirm('Hapus pertanyaan ini?');">Hapus</a>
            </div>
        <?php endif; ?>
    </div>
            ...
            <div class="answer">
                ...
                <?php if($_SESSION['user_id'] == $row['user_id']): ?>
                    <div class="answer-actions" style="margin-top:10px;">
                        <a href="edit_answer.php?id=<?= $row['id'] ?>" style="color:orange;">Edit</a>
                        <a href="delete_answer.php?id=<?= $row['id'] ?>" style="color:red;" onclick="return confirm('Hapus jawaban ini?');">Hapus</a>
                    </div>
                <?php endif; ?>
