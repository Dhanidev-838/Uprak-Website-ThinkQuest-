...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; background:#fff; display:flex; justify-content:center; align-items:flex-start; padding-top:50px; }
...
<div class="container">
    ...
    <p style="text-align:center;"><a href="index.php" class="back-home">Kembali ke Home</a></p>
</div>
</body>
</html>
